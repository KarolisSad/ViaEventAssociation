...
public class SetMaxGuests
{
    ...
    public void UpdateDescription_F1()
    {
        ...
        Assert.That(resultBase.ErrorMessages[0], Is.EqualTo( "Maximum number of guests for an active event cannot be reduced."));
    }
    ...
    public void UpdateDescription_F2()
    {
        ...
        Assert.IsTrue(!resultBase.IsSuccess);
        Assert.That(resultBase.ErrorMessages.Count, Is.EqualTo(1));
        Assert.That(resultBase.ErrorMessages[0], Is.EqualTo( "A cancelled event cannot be modified."));
    }
    
    [Test]
    public void UpdateDescription_F3()
    {
        // NEEDS LOCATION LOGIC
    }
    ...
    public void UpdateDescription_F4()
    {
        ...
        Assert.IsTrue(!resultBase.IsSuccess);
        Assert.That(resultBase.ErrorMessages.Count, Is.EqualTo(1));
        Assert.That(resultBase.ErrorMessages[0], Is.EqualTo( "The maximum number of guests cannot be less than 5."));
    }
