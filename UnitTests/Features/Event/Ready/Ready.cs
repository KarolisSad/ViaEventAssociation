...
public class Ready
{
    ...
    public void Setup()
    {
        ...
        validCreatedEvent.SetStartDateTime(new DateTime(2024, 06, 06, 12, 21, 12));
        validCreatedEvent.SetEndDateTime(new DateTime(2024, 06, 07, 12, 21, 12));
    ...
    public void UpdateDescription_F2()
    {
        ...
        Assert.That(resultBase.ErrorMessages[0], Is.EqualTo("A cancelled event cannot be readied."));
    }
